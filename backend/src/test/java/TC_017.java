...
public class AuthServiceTest {
    ...
    public void setUp() {
        ...
        user.setLastName("Boussaidi");
        user.setEmail("adel.Boussaidi@enicar.ucar.tn");
        user.setPassword("Boussaidi");
        user.setRole("ADMIN");
    ...
    public void testForgotPassword() throws IOException, MessagingException {
        // Arrange
        when(userRepository.findByEmail("adel.Boussaidi@enicar.ucar.tn")).thenReturn(user);
